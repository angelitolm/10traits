      ...
      <div style={pageStyle}>
        <div style={parentStyle}>
          <div className="hrangeslider" >
            <Slider style={{ float: 'left', width: 25, height: this.state.heightListGroup, marginLeft: '5px', marginBottom: 15, marginTop: 15 }} vertical min={0} max={100} onChange={log} defaultValue={0}  />
          </div>
        </div>
      </div>
    )
